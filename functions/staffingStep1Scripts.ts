...
${SIG}`
  },
  {
    ...
    subject: "{{first_name}} — {{random|hiring activity|market notes|quick look}}",
...
${SIG}`
  },
  {
    ...
    subject: "{{first_name}} — {{random|accounts identified|short list|pipeline}}",
...
${SIG}`
  },
  {
    ...
    subject: "{{first_name}} — {{random|niche fit|your specialty|market fit}}",
...
${SIG}`
  },
  {
    ...
    subject: "{{first_name}} — {{random|market notes|research note|quick share}}",
...
${SIG}`
  },
  {
    ...
    subject: "{{first_name}} — {{random|qualified demand|active hiring|demand signal}}",
...
${SIG}`
  },
  {
    ...
    subject: "{{first_name}} — {{random|hiring demand|already hiring|real demand}}",
...
${SIG}`
  },
  {
    ...
    subject: "{{first_name}} — {{random|less wasted outreach|better targeting|focused BD}}",
...
${SIG}`
  },
  {
    ...
    subject: "{{first_name}} — {{random|warmer conversations|hiring managers|better intros}}",
...
${SIG}`
  },
  {
    ...
    subject: "{{first_name}} — {{random|steadier pipeline|more predictable BD|pipeline help}}",
...
${SIG}`
  },
  {
    ...
    subject: "{{first_name}} — {{random|real demand|qualified intros|hiring signal}}",
